...
export const initialTechnicians: TechProfile[] = [
  {
    ...
    name: 'Carlos Mendoza',
    category: 'mecanico',
    secondaryCategories: ['electricista', 'reparacion_hogar'],
    title: 'Mecánico Automotriz Certificado - ASE',
    rating: 4.9,
    reviewCount: 142,
    experienceYears: 12,
    location: 'Bella Vista, Ciudad de Panamá',
    companyName: 'Abrego Motors S.A.',
    hourlyRate: 25,
  ...
  },
  {
    ...
    category: 'tecnico_ac',
    secondaryCategories: ['refrigeracion', 'plantas_electricas'],
    title: 'Técnico HVAC / Aire Acondicionado',
    rating: 4.8,
    reviewCount: 98,
    experienceYears: 8,
    location: 'San Francisco, Ciudad de Panamá',
    companyName: 'AirCool Panamá',
    hourlyRate: 20,
  ...
  },
  {
    ...
    hourlyRate: 15,
    bio: 'Corte de césped y poda profesional.',
    certifications: ['Técnico Paisajista'],
    portfolioImages: [],
    plan: 'basic',
    completedJobs: 22,
    isVerified: true
  },
  {
    ...
    hourlyRate: 45,
    bio: 'Fotografía de inmuebles y eventos.',
    certifications: ['Diplomado Artes'],
    portfolioImages: [],
    plan: 'pro',
    completedJobs: 85,
    isVerified: true
  },
  {
    ...
    hourlyRate: 35,
    bio: 'Corte y color profesional.',
    certifications: ['Master Colorista'],
    portfolioImages: [],
    plan: 'enterprise',
    completedJobs: 120,
    isVerified: true
  },
  {
    ...
    name: 'Roberto Chiari',
    category: 'ascensores',
    title: 'Ingeniero de Elevadores',
    rating: 4.9,
    reviewCount: 60,
    experienceYears: 15,
    location: 'Obarrio, Panamá',
    hourlyRate: 50,
    bio: 'Mantenimiento certificado de ascensores multimarca.',
    certifications: ['Certificación Schindler/Otis'],
    portfolioImages: [],
    plan: 'enterprise',
    completedJobs: 200,
    isVerified: true
  ...
  {
    id: 'tech-10',
    name: 'Abogado Javier Ríos',
    category: 'legal',
    title: 'Consultor Legal Corporativo',
    rating: 4.8,
    reviewCount: 45,
    experienceYears: 12,
    location: 'El Dorado, Panamá',
    hourlyRate: 80,
    bio: 'Especialista en contratos de PH y trámites comerciales.',
    certifications: ['Idoneidad Profesional'],
    portfolioImages: [],
    plan: 'pro',
    completedJobs: 90,
    isVerified: true
