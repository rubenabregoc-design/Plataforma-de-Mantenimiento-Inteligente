...
export default function PreTripInspectionModal({ isOpen, onClose, assetName, onSave }: PreTripInspectionModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[700] bg-black/90 backdrop-blur-md flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-[#121317] border border-white/10 rounded-[3rem] p-8 md:p-10 space-y-8 shadow-2xl animate-fade-in-up flex flex-col max-h-[90vh]">
        ...
        <button
          ...
          className="w-full py-5 bg-[#5d3cfe] text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] shadow-xl shadow-[#5d3cfe]/20 active:scale-95 transition-all flex items-center justify-center gap-3 shrink-0"
        >
